                        ...
                        <td class="vcenter text-left">
                            @if(!empty($dataForView['access_by']))
                                ...
                                @if($dataForView['product_name'] == "Accounts" && !$isTouchPoint)
                                    <input type="hidden" id="workingBalance" value="{{ !empty($dataForView['balance']) ? $dataForView['balance'] : '' }}">
                        ...
                        <table style="margin-top: 15px; margin-bottom: 15px">
                            ...
                            @FOREACH($dataForView['w_form_attachment'] AS $attch)
                                <tr>
                                    ...
                                    @if ($dataForView['depricate_wform_type'] == 1192)
                            ...
                            {{-- ignore new attachment for bpID id no 1192--}}
                            @if ($dataForView['depricate_wform_type'] != 1192)
                                        ...
                                        <div class="input-group">
                                            {!!
                                                Form::select('bpid_type', [
                                                    ...
                                                    'disabled' => !($subgroupId == 1518 && in_array('1', $unitIds)),
                                                ])
                                            !!}
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $(document).on("click", ".ballanceInquery", function (e) {
                        ...
                        var workingBalance = $('#workingBalance').val();
