                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 5px; ">
                                    ...
                                    <p class="value-text" style="margin-bottom: 0">{{ !empty($raw->applicant_first_applicant_date_of_birth) ? \Carbon\Carbon::parse($raw->applicant_first_applicant_date_of_birth)->format('d-m-Y') : '' }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item-wrap" style="padding: 1rem 0px">
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 5px; ">
                                    <p style="margin-bottom: 0">Date of Birth:</p>
                                    <p class="value-text" style="margin-bottom: 0">{{ !empty($raw->applicant_second_applicant_date_of_birth) ? \Carbon\Carbon::parse($raw->applicant_second_applicant_date_of_birth)->format('d-m-Y') : '' }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item-wrap" style="padding: 1rem 0px">
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 5px; ">
                                    <p style="margin-bottom: 0">Date of Birth:</p>
                                    <p class="value-text" style="margin-bottom: 0">{{ !empty($raw->applicant_third_applicant_date_of_birth) ? \Carbon\Carbon::parse($raw->applicant_third_applicant_date_of_birth)->format('d-m-Y') : '' }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item-wrap" style="padding: 1rem 0px">
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 5px; ">
                                    <p style="margin-bottom: 0">Date of Birth:</p>
                                    <p class="value-text" style="margin-bottom: 0">{{ !empty($raw->applicant_fourth_applicant_date_of_birth) ? \Carbon\Carbon::parse($raw->applicant_fourth_applicant_date_of_birth)->format('d-m-Y') : '' }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <tbody style="word-break: break-all;">
                        @if ($raw->applicant_first_nominee_name)
                            <tr>
                                ...
                                <td class="vcenter text-center value-text" style="font-size:9px">{{ !empty($raw->applicant_first_nominee_dob) ? \Carbon\Carbon::parse($raw->applicant_first_nominee_dob)->format('d-m-Y') : '' }}</td>
                        ...
                        @if ($raw->applicant_second_nominee_name)
                            <tr>
                                ...
                                <td class="vcenter text-center value-text" style="font-size:9px">{{ !empty($raw->applicant_second_nominee_dob) ? \Carbon\Carbon::parse($raw->applicant_second_nominee_dob)->format('d-m-Y') : '' }}</td>
                        ...
                        @if (optional($raw)->applicant_third_nominee_name)
                            <tr>
                                ...
                                <td class="vcenter text-center value-text" style="font-size:9px">{{ !empty($raw->applicant_third_nominee_dob) ? \Carbon\Carbon::parse($raw->applicant_third_nominee_dob)->format('d-m-Y') : '' }}</td>
                        ...
                        @if (optional($raw)->applicant_fourth_nominee_name)
                            <tr>
                                ...
                                <td class="vcenter text-center value-text">{{ !empty($raw->applicant_fourth_nominee_dob) ? \Carbon\Carbon::parse($raw->applicant_fourth_nominee_dob)->format('d-m-Y') : '' }}</td>
                ...
                <div class="item-photo-wrap">
                        ...
                        <div class="photo-item">
                            ...
                            @if (!empty($raw->applicant_1_passport))
                                <div class="img-box" style="margin-bottom: 10px">
                                    <img style="width: 100px; height: 90px" src="{{ asset('public/attachments/' . $raw->applicant_1_passport) }}" alt="Passport Image">
                                    <p style="margin-top: 5px; margin-bottom:0">First Applicant</p>
                                </div>
                    ...
                    @if (!empty($raw->applicant_2_passport))
                        <div class="photo-item">
                            ...
                            @if (!empty($raw->applicant_2_passport))
                                <div class="img-box" style="margin-bottom: 10px">
                                    <img style="width: 100px; height: 90px" src="{{ asset('public/attachments/' . $raw->applicant_2_passport) }}" alt="Passport Image Two">
                                    <p style="margin-top: 5px; margin-bottom:0">Second Applicant</p>
                                </div>
                                @php $hasAnyFile = true; @endphp
                            @endif
                    ...
                    @if (!empty($raw->nominee_1_image))
                        <div class="photo-item">
                            @php $hasAnyFile = false; @endphp

                            @if (!empty($raw->nominee_1_image))
                                <div class="img-box" style="margin-bottom: 10px">
                                    <img style="width: 100px; height: 90px" src="{{ asset('public/attachments/' . $raw->nominee_1_image) }}" alt="Passport Image">
                                    <p style="margin-top: 5px; margin-bottom:0">First Nominee</p>
                                </div>
                                @php $hasAnyFile = true; @endphp
                            @endif

                            @unless ($hasAnyFile)
                                Please attach a Recent Passport Size Color Photograph of 1st Nominee/Authorized Signatory
                            @endunless
                        </div>
                    @else
                        <div class="photo-item">
                    ...
                    @if (!empty($raw->nominee_2_image))
                        <div class="photo-item">
                            @php $hasAnyFile = false; @endphp

                            @if (!empty($raw->nominee_2_image))
                                <div class="img-box" style="margin-bottom: 10px">
                                    <img style="width: 100px; height: 90px" src="{{ asset('public/attachments/' . $raw->nominee_2_image) }}" alt="Passport Image Third">
                                    <p style="margin-top: 5px; margin-bottom:0">Second Nominee</p>
                                </div>
                                @php $hasAnyFile = true; @endphp
                            @endif

                            @unless ($hasAnyFile)
                                Please attach a Recent Passport Size Color Photograph of 2nd Nominee/Authorized Signatory
                            @endunless
                        </div>
                    @else
                        <div class="photo-item">
                        ...
                        <tr>
                            ...
                            <td class="vcenter text-center">     
                                @if (!empty($raw->applicant_1_signature))
                                    ...
                                    <span class="value-text" style="margin-left: 10px">{{ !empty($raw->create_time) ? \Carbon\Carbon::parse($raw->create_time)->format('d-m-Y') : '' }}</span>
                                @else
                                    -
                                @endif     
                            </td>
