	...
	$ciApimodel = new CustomerInterfaceAPI();
        ...
        if (!empty($primeId) && !empty($sessionId)) {
            ...
            $headers = [
                ...
                'Authorization: Basic cHJpbWVzZXJ2ZToxMjM0NTY='
            ];
		...
		$httpCode = curl_getinfo($ch, CURLINFO_HTTP_CODE);
                ...
                curl_close($ch);
                 ...
                 //$response = '{"success":true,"data":{"loginId":"1fd4027460ea131cda5785309dc07220","cfId":"2586610", "callbackUrl": "https://primeservecust-uat.primebank.com.bd/"}}';
            }catch (\Exception $e){
