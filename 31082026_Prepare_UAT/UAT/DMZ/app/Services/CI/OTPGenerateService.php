...
class OTPGenerateService
{
	...
	//$response = "";
        ...
        if (!empty($accessToken) && !empty($accessToken['responseCode']) && $accessToken['responseCode'] == 200){
            $restUrl = "https://pblcon-uat-lb.primebank.com.bd:8443/utility-api/v1/sms/sms-service/send-request";
	    
	    Log::error('access_code', [$accessToken['data']['accessToken']]);
	    Log::error('SMS', [$unmaskedSms]);
            ...
            //$payloadUnmasked["messageBody"] = $unmaskedSms;
