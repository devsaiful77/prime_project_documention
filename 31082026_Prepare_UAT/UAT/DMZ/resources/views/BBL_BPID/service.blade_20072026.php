            ...
            <form id="cifFormApp" action="{{ url('/CI/newWForm') }}" method="POST">
                ...
                <div class="container-fluid custom-layout app_view">
                    <div class="dropdown-wrapper mb-4">
                        ...
                        <select class="" name="account_number" id="accountNumberMobile">
                    ...
                    @if(getId('AUCTION_REQUEST') == $issueId)
                        <div class="form-group">
                            ...
                            <label class="form-check-label" for="checkme">
                                ...
                                <a href="https://www.primebank.com.bd/wealth-management" target="_blank">
                                        ...
                                        <div class="card card-color">
                                            <div class="card-body" style="padding:0">
                                                <div class="form-group" style="padding-bottom: 8px;">
                                                    ...
                                                    <select class="" name="account_number" id="accountNumberWeb" >
