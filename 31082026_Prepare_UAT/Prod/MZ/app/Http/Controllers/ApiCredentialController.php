...
class ApiCredentialController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'PULL_CARD_API_BY_CIF' => 'required|string',
            'PULL_CARD_API_BY_MOBILE' => 'required|string',
        ...
        $tmpApiCredential->PULL_CARD_API_BY_CIF = $request->PULL_CARD_API_BY_CIF;
        $tmpApiCredential->PULL_CARD_API_BY_MOBILE = $request->PULL_CARD_API_BY_MOBILE;
    ...
    public function approveApiCredential($id)
    {
        ...
        try {
            ...
            $apiCredential = [
                ...
                'PULL_CARD_API_BY_CIF' => $apiCredentialTmp->PULL_CARD_API_BY_CIF,
                'PULL_CARD_API_BY_MOBILE' => $apiCredentialTmp->PULL_CARD_API_BY_MOBILE,
    ...
    public function checkerTableData($id)
    {
        ...
        $tmpData->PULL_CARD_API_BY_CIF = $tmpData->PULL_CARD_API_BY_CIF;
        $tmpData->PULL_CARD_API_BY_MOBILE = $tmpData->PULL_CARD_API_BY_MOBILE;
        $tmpData->SMS_API_URL = $tmpData->SMS_API_URL;
        $tmpData->loan_api_request = $tmpData->loan_api_request;

        $tmpData->ci_username = $tmpData->ci_username;
        $tmpData->ci_password = $tmpData->ci_password;
        $tmpData->Post_No_Debit_API_URL = $tmpData->Post_No_Debit_API_URL;
        $tmpData->BPID_API_URL = $tmpData->BPID_API_URL;
        ...
        if (isset($oldData)) {
            ...
            $oldData->PULL_CARD_API_BY_CIF = $oldData->PULL_CARD_API_BY_CIF ?? 'N/A';
            $oldData->PULL_CARD_API_BY_MOBILE = $oldData->PULL_CARD_API_BY_MOBILE ?? 'N/A';
            $oldData->SMS_API_URL = $oldData->SMS_API_URL ?? null;
            $oldData->loan_api_request = $oldData->loan_api_request ?? null;

            $oldData->ci_username = $oldData->ci_username ?? null;
            $oldData->ci_password = $oldData->ci_password ?? null;
            $oldData->Post_No_Debit_API_URL = $oldData->Post_No_Debit_API_URL ?? null;
            $oldData->BPID_API_URL = $oldData->BPID_API_URL ?? null;
        }

        $columnsToSend = ['user_name', 'user_password', 'ci_username', 'ci_password', 'token_url', 'Pull_API_URL','PULL_CARD_API_BY_CIF', 'PULL_CARD_API_BY_MOBILE', 'SMS_API_URL', 'loan_api_request', 'Post_No_Debit_API_URL', 'BPID_API_URL'];
