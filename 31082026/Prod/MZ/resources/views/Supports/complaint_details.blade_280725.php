                            ...
                            @ENDIF
                                ...
                                @IF($dataForView['form_status'] != -1 && $dataForView['form_status'] != 11 && $dataForView['form_status'] != 12)
                                    @if($is_regular_flow->getFlowType($dataForView['main_id'])==\App\Enum\FlowEnum::FORWARD)
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <textarea class="form-control m-0 w-100" id="complaint_summary" name="com_summary" autocomplete="off" placeholder="Complaint Summary" cols="30" rows="3">{{ old('com_summary') }}</textarea>
                                                @if($errors->has('com_summary'))
                                                    <div class="error-message">{{ $errors->first('com_summary') }}</div>
                                                @endif
                                            </div>
                                            <div class="col-md-2">
                                                <textarea class="form-control m-0 w-100" id="complaint_root_cause" name="com_root_cause" autocomplete="off" placeholder="Complaint Root Cause" rows="3">{{ old('com_root_cause') }}</textarea>
                                                @if($errors->has('com_root_cause'))
                                                    <div class="error-message">{{ $errors->first('com_root_cause') }}</div>
                                                @endif
                                            </div>
                                            <div class="col-md-2">
                                                <textarea class="form-control m-0 w-100" id="action_taken" name="action_taken" autocomplete="off" placeholder="Action Taken" rows="3">{{ old('action_taken') }}</textarea>
                        ...
                        @if($is_regular_flow->getFlowType($dataForView['main_id'])==\App\Enum\FlowEnum::FORWARD)
                            ...
                            @IF($dataForView['form_status'] != -1 && $dataForView['form_status'] != 11 && $dataForView['form_status'] != 12)
                                    ...
                                    @if($is_regular_flow->getFlowType($dataForView['main_id'])==\App\Enum\FlowEnum::FORWARD)
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <textarea class="form-control m-0 w-100" id="complaint_summary" name="com_summary" autocomplete="off" placeholder="Complaint Summary" rows="3">{{ old('com_summary') }}</textarea>
                                                @if($errors->has('com_summary'))
                                                    <div class="error-message">{{ $errors->first('com_summary') }}</div>
                                                @endif
                                            </div>
