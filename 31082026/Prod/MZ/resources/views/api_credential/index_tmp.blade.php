...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <th scope="col">Card Pull API URL (CIF)</th>
            <th scope="col">Card Pull API URL (Mobile)</th>
        ...
        <tr>
            ...
            <td>{{ $data->Pull_API_URL }}</td>
            <td>{{ $data->loan_api_request }}</td>
            <td>{{ $data->SMS_API_URL }}</td> 
            <td>{{ $data->PULL_CARD_API_BY_CIF }}</td>
            <td>{{ $data->PULL_CARD_API_BY_MOBILE }}</td>
