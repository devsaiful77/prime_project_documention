    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Group Info Actions</h5>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Group Actions</h5>
        ...
        <tbody style="word-break: break-all;">
            ...
            @FOREACH($groupInfoTmp as $data)
                <tr>
                    ...
                    <td class="vcenter text-center">@if($data['group_level_id']==1) {{ 'Touch Point' }}@else{{ 'N/A' }}@endif</td>
                    ...
                    <td class="vcenter actions text-center">
                        ...
                        @if($isChecker == false)
                            @if($data['form_status'] == 7)
                                <a href="{{ url('group-info/tmp-edit', $data['id']) }}" class="btn btn-success gradient ajax_page" title="Edit" escape="false"> <i class="fa fa-pencil"></i> Edit</a>
                            @endif
                                <a href="{{ url('delete/tmp-data', ['id' => $data['id'], 'table' => 'group_info_tmps']) }}" class="btn btn-danger gradient ajax_page" title="Delete" escape="false">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#sendBack-btn').click(function(e){
                ...
                const id = $('#assign_button').data('id');
                let url = "{{ url('group-info/send-back', '') }}";
                url += '/' + id;
            ...
            $('#approve-btn').click(function(){
                const id = $('#assign_button').data('id');
                let url = "{{ url('group-info/approve', '') }}";
                url += '/' + id;
