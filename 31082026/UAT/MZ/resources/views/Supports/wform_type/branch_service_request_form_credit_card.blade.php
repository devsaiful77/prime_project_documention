<tr>
    ...
    <td class="vcenter">
        {{ Form::select('branch_service_type', [null=>'Please Select'] +  $allWformMasterData['branch_service_type_cc'], (!empty($dataForView['branch_service_type'])) ? $dataForView['branch_service_type'] : "", ['class'=>'form-control']) }}
