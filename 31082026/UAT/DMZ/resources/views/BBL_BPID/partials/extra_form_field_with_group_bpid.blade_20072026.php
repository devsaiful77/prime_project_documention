        ...
        @if($single['fieldset_title'] != "")
            <fieldset onload="validateAllInputs()" class="fieldset-wrap"  @if(!empty($single['fieldset_id']))
                ...
                <legend>
                    ...
                    @if ($issueId == 1192)
                        <button type="button" 
                                class="btn btn-sm fieldset-toggle-btn" 
...
@push('js')
    ...
    <script nonce="{{ app('csp_nonce') }}">
        $(document).ready(function () {
            // Collapsible fieldsets for issue 1192
            

            const bpidFieldsets = [
                'BPID_first_applicant',
                'BPID_contact_details',
                'BPID_bank_details',
                'BPID_second_applicant',
                'BPID_third_applicant',
                'BPID_fourth_applicant',
                'BPID_first_nominee',
                'BPID_second_nominee',
                'BPID_third_nominee',
                'BPID_fourth_nominee',
