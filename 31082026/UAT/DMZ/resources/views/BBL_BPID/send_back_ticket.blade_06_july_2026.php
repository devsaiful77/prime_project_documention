    ...
    <div class="d-block d-lg-none align-self-center">
        <form id="cifFormApp" action="{{ url('/CI/updateWForm') }}" method="POST">
            ...
            <div class="container-fluid custom-layout app_view">
                ...
                <div class="dropdown-wrapper mb-4">
                    @include('BBL_BPID.partials.extra_form_field_with_group_app_bpid', ['issue_fields' => $fields, 'arraySingle' => $arraySingle])
                </div>
                <div id="issue_attachment_item">
                    @include('BBL_BPID.partials.CIissue_attachment_item_app', ['attachment_item' => $attachment_item, 'send_back' => true])
                </div>
