                    ...
                    <div class="row g-2 mb-4">
                        <div class="col-12">
                            <div style="color: #699DC5;">
                                <h5 class="service_title">Complaint Type</h5>
                            </div>
                        </div>
                            ...
                            <div class="card type-item-bg">
                                <div class="card-body ps-0 pe-0">
                                    <div class="bbl_customer_service text-center">
                                        <a href="javascript:void(0)" class="text-decoration-none text-center text-dark fs-5 complaintType" data-url="{{ route('CI.account-verify', ['product_type' => 2, 'CIToken' => $ci_token, 'request_type' => 'complaint']) }}">
                                            <div class="img-round">
                        ...
                        <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3 col-xxl-2 align-self-start">
                            <div class="card type-item-bg">
                                <div class="card-body ps-0 pe-0">
                                    <div class="bbl_customer_service text-center">
                                        <a href="#"
                                           class="text-decoration-none text-center text-dark fs-5 complaintType" data-url="{{ route('CI.account-verify', ['product_type' => 1, 'CIToken' => $ci_token, 'request_type' => 'complaint']) }}">
                                            <div class="img-round">
                        ...
                        <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3 col-xxl-2 align-self-start">
                            <div class="card type-item-bg">
                                <div class="card-body ps-0 pe-0">
                                    <div class="bbl_customer_service text-center">
                                        <a href="#"
                                           class="text-decoration-none text-center text-dark fs-5 complaintType" data-url="{{ route('CI.account-verify', ['product_type' => 3, 'CIToken' => $ci_token, 'request_type' => 'complaint']) }}">
                                            <div class="img-round">
                        ...
                        <div class="col-4 col-sm-4 col-md-3 col-lg-3 col-xl-3 col-xxl-2 align-self-start">
                            <div class="card type-item-bg">
                                <div class="card-body ps-0 pe-0">
                                    <div class="bbl_customer_service text-center">
                                        <a href="javascript:void(0)" class="text-decoration-none text-center text-dark fs-5 complaintType"  data-url="{{ route('CI.account-verify', ['product_type' => 4, 'CIToken' => $ci_token, 'request_type' => 'complaint']) }}">
                                            <div class="img-round">
                                                <img class="mx-auto d-block" src="{{ URL::asset('public/BBL_CI/ui/credit_card.png') }}" alt="">
                                            </div>
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            <div class="history-title">
                                <h5 class="service_title">Complaint Ticket History</h5>
                            </div>
                        </div>
                            ...
                            <div class="card type-item-bg">
                                <div class="card-body ps-0 pe-0">
                                    <div class="bbl_customer_service ">
                                        <a href="javascript:void(0)" class="text-decoration-none text-center text-dark fs-5 complaintTicketHistory"  data-url="{{ route('CI.complaint-send-back-status', ['CIToken' => $ci_token, 'request_type' => 'complaint']) }}">
                                            <div class="img-round">
                                                <img class="mx-auto d-block" src="{{ URL::asset('public/BBL_CI/ui/send_back.png') }}" alt="">
                                            </div>
                        ...
                        <div class="col-4 col-sm-4 col-md-3 col-lg-2 col-xl-3 col-xxl-2 align-self-center">
                            <div class="card type-item-bg">
                                <div class="card-body ps-0 pe-0">
                                    <div class="bbl_customer_service ">
                                        <a href="javascript:void(0)" class="text-decoration-none text-center text-dark fs-5 complaintTicketHistory" data-url="{{ route('CI.comaplaint-ticket-status', ['CIToken' => $ci_token, 'request_type' => 'complaint']) }}">
                                            {{-- <img class="mx-auto d-block" src="{{ URL::asset('public/BBL_CI/img/t_s.svg') }}" alt=""> --}}
                                            <div class="img-round">
                                                <img class="mx-auto d-block" src="{{ URL::asset('public/BBL_CI/ui/ticket_status.png') }}" alt="">
                                            </div>
...
@push('js')
    <script nonce="{{ app('csp_nonce') }}">
	    ...
	    $(document).on('click','.complaintType', function(){
		let url = $(this).data('url');
		openURL(url);
	    });

	    $(document).on('click','.complaintTicketHistory', function(){
		let url = $(this).data('url');
		openURL(url);
	    });
