    ...
    <div class="action-print-wrap">
        ...
        <div class="title-header-wrap">
            <div class="title-header">
                <div class="title-header-left">
                    <p>Head of Branch</p>
                    <p style="margin-bottom: 5px">__________________ Branch</p>
                    <p>Prime Bank PLC.</p>
                </div>
            ...
            <div class="item-des-wrap item-decla-wrap">
                ...
                <div class="sign-footer">
                    ...
                    <div class="sign-footer-right">
                        <p> 16218, 02223383837 <small>(Locally)</small> +88 09604016218, +88 09612316218 <small>(From
                                overseas)</small></p>
        ...
        <div class="item-section-wrap item-terms-wrap">
            ...
            <ol>
                ...
                <li>
                    Applicant name and contact details must be identical with BP ID & BP ID linked account with Prime Bank
                    PLC.
                </li>
                <li>
                    Auction Request Form must be submitted at the desired Prime Bank PLC branch at least 01 day prior to the
                    bidding date.
                </li>
                <li>
                ...
                <li>
                    Bidding month and date must be declared clearly in the form. The Auction Calendar is available under the
                    Wealth Management section of the official website of Prime Bank PLC:
                    <a href="https://www.primebank.com.bd" target="_blank">www.primebank.com.bd</a>
                </li>
                <li>
                    Prime Bank PLC will participate in the bidding (according to your instruction) subject to availability
                    of the settlement amount in the BP linked account with Prime Bank PLC from the day before the bidding
                    date, and the amount must remain in the account until realization. Settlement amount may differ
                    according to the allotment confirmation by BB.
                </li>
                <li>
