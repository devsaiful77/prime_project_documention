        ...
        @if ($raw->applicant_first_applicant_gender)
            <div>
                ...
                <div class="item-section-wrap">
                    ...
                    <div class="item-wrap">
                        <div class="bp-id-item">{{ $raw->applicant_name_of_the_account ?? '' }}</div>
                    </div>
                </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    ...
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_first_applicant_date_of_birth ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    ...
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_first_applicant_mothers_name ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Father's Name:</p>
                                    <p style="opacity: .5 ; margin-bottom: 0">{{ $raw->applicant_first_applicant_fathers_name ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    ...
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_first_applicant_nidpassport ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">e-TIN No. (if any):</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_first_applicant_etin_no_if_any ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    ...
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_first_applicant_occupation ?? '' }}</p>
                                </div>
                            </div>
                        </div>
        ...
        @if ($raw->applicant_second_applicant_gender)
            <div class="applicant-wrap">
                ...
                <div class="item-section-wrap">
                    <div class="item-title">4. Name of the Account:</div>
                    <div class="item-wrap">
                        <div class="bp-id-item">{{ $raw->applicant_second_applicant_name ?? '' }}</div>
                    </div>
                </div>
                    ...
                    <div class="item-wrap">
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Date of Birth:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_second_applicant_date_of_birth ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Mother's Name:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_second_applicant_mothers_name ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Father's Name:</p>
                                    <p style="opacity: .5 ; margin-bottom: 0">{{ $raw->applicant_second_applicant_fathers_name ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">NID/Passport No:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_second_applicant_nidpassport ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">e-TIN No. (if any):</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_second_applicant_etin_no_if_any ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Occupation:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_second_applicant_occupation ?? '' }}</p>
                                </div>
                            </div>
                        </div>
        ...
        @if ($raw->applicant_third_applicant_gender)
            <div class="applicant-wrap">
                ...
                <div class="item-section-wrap">
                    <div class="item-title">4. Name of the Account:</div>
                    <div class="item-wrap">
                        <div class="bp-id-item">{{ $raw->applicant_third_applicant_name ?? '' }}</div>
                    </div>
                </div>
                    ...
                    <div class="item-wrap">
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Date of Birth:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_third_applicant_date_of_birth ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Mother's Name:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_third_applicant_mothers_name ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Father's Name:</p>
                                    <p style="opacity: .5 ; margin-bottom: 0">{{ $raw->applicant_third_applicant_fathers_name ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">NID/Passport No:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_third_applicant_nidpassport ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">e-TIN No. (if any):</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_third_applicant_etin_no_if_any ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Occupation:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_third_applicant_occupation ?? '' }}</p>
                                </div>
                            </div>
                        </div>
        ...
        @if ($raw->applicant_fourth_applicant_gender)
            <div class="applicant-wrap">
                ...
                <div class="item-section-wrap">
                    <div class="item-title">4. Name of the Account:</div>
                    <div class="item-wrap">
                        <div class="bp-id-item">{{ $raw->applicant_fourth_applicant_name ?? '' }}</div>
                    </div>
                </div>
                    ...
                    <div class="item-wrap">
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            ...
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Date of Birth:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_fourth_applicant_date_of_birth ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Mother's Name:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_fourth_applicant_mothers_name ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Father's Name:</p>
                                    <p style="opacity: .5 ; margin-bottom: 0">{{ $raw->applicant_fourth_applicant_fathers_name ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">NID/Passport No:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_fourth_applicant_nidpassport ?? '' }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">e-TIN No. (if any):</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_fourth_applicant_etin_no_if_any ?? '' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin: 5px; 0px;">
                            <div class="col-6">
                                <div style="display: flex; align-items: center; gap: 30px; ">
                                    <p style="margin-bottom: 0">Occupation:</p>
                                    <p style="opacity: .5; margin-bottom: 0">{{ $raw->applicant_fourth_applicant_occupation ?? '' }}</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="item-wrap">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <span style="margin-left: 15px">{{ $raw->applicant_present_address ?? '' }}</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        Permanent Address:
                        <span style="margin-left:15px">{{ $raw->applicant_permanent_address ?? '' }}</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        Phone No:
                        <span style="margin-left: 15px">{{ $raw->applicant_phone_no ?? '' }}</span>
                    </div>
                    <div class="col-6">
                        Mobile No: 
                        <span style="margin-left: 15px">{{ $raw->applicant_mobile_no ?? '' }}</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        Email:
                        <span style="margin-left: 15px">{{ $raw->applicant_email ?? '' }}</span>
                    </div>
                </div>
        ...
        <div class="item-section-wrap">
            ...
            <div class="item-wrap">
                ...
                <div class="row">
                    <div class="col-6">
                        Bank Name:
                        <span style="margin-left: 15px">{{ $raw->applicant_bank_name ?? '' }}</span>
                    </div>
                    <div class="col-6">
                        Branch Name:
                        <span style="margin-left: 15px">{{ $raw->applicant_branch_name ?? '' }}</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        Account Number:
                        <span style="margin-left: 15px">{{ $raw->applicant_account_number ?? '' }}</span>
                    </div>
                    <div class="col-6">
                        Account Type:
                        <span style="margin-left: 15px">{{ $raw->applicant_account_type ?? '' }}</span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        Routing No.:
                        <span style="margin-left: 15px">{{ $raw->applicant_routing_no ?? '' }}</span>
                    </div>
                </div>
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tbody style="word-break: break-all;">
                        @if ($raw->applicant_first_nominee_name)
                            <tr>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_first_nominee_name ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_first_nominee_nidpassportbirth_no ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:7px">{{ $raw->applicant_first_nominee_address ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_first_nominee_relation_with_account_holder ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_first_nominee_dob ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_first_nominee_payable ?? '' }}</td>
                                <td class="vcenter text-center">
                                    @if(!empty($raw->nominee_1_signature))
                                        <div class="img-box">
                                            <img src="{{ asset('public/attachments/'.$raw->nominee_1_signature) }}" width="100">
                                        </div>
                                    @else
                                        ---
                                    @endif
                        ...
                        @if ($raw->applicant_second_nominee_name)
                            <tr>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_second_nominee_name ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_second_nominee_nidpassportbirth_no ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_second_nominee_address ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_second_nominee_relation_with_account_holder ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_second_nominee_dob ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_second_nominee_payable ?? '' }}</td>
                                <td class="vcenter text-center">
                                    @if(!empty($raw->nominee_2_signature))
                                        <div class="img-box">
                                            <img src="{{ asset('public/attachments/'.$raw->nominee_2_signature) }}" width="100">
                                        </div>
                                    @else
                                        ---
                                    @endif
                        ...
                        @if (optional($raw)->applicant_third_nominee_name)
                            <tr>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_third_nominee_name ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_third_nominee_nidpassportbirth_no ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_third_nominee_address ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_third_nominee_relation_with_account_holder ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_third_nominee_dob ?? '' }}</td>
                                <td class="vcenter text-center" style="font-size:9px">{{ $raw->applicant_third_nominee_payable ?? '' }}</td>
                                <td class="vcenter text-center">
                                    @if(!empty($raw->nominee_3_signature))
                                        <div class="img-box">
                                            <img src="{{ asset('public/attachments/'.$raw->nominee_3_signature) }}" width="100">
                                        </div>
                                    @else
                                        ---
                                    @endif
                        ...
                        @if (optional($raw)->applicant_fourth_nominee_name)
                            <tr>
                                <td class="vcenter text-center">{{ $raw->applicant_fourth_nominee_name ?? '' }}</td>
                                <td class="vcenter text-center">{{ $raw->applicant_fourth_nominee_nidpassportbirth_no ?? '' }}</td>
                                <td class="vcenter text-center">{{ $raw->applicant_fourth_nominee_address ?? '' }}</td>
                                <td class="vcenter text-center">{{ $raw->applicant_fourth_nominee_relation_with_account_holder ?? '' }}</td>
                                <td class="vcenter text-center">{{ $raw->applicant_fourth_nominee_dob ?? '' }}</td>
                                <td class="vcenter text-center">{{ $raw->applicant_fourth_nominee_payable ?? '' }}</td>
                                <td class="vcenter text-center">
                                    @if(!empty($raw->nominee_4_signature))
                                        <div class="img-box">
                                            <img src="{{ asset('public/attachments/'.$raw->nominee_4_signature) }}" width="100">
                                        </div>
                                    @else
                                        ---
                                    @endif
                    ...
                    <tbody style="word-break: break-all;">
                        <tr>
                            ...
                            <td class="text-left" style="padding: 0">
                                <div class="info-text" style="border-bottom: 1px solid #126c38; padding: 3px">Father's Name: <span style="margin-left: 5px"></span></div>
                                <div class="info-text" style="border-bottom: 1px solid #126c38; padding: 3px">Mother's Name: <span style="margin-left: 5px"></span></div>
                                <div class="info-text" style="border-bottom: 1px solid #126c38; padding: 3px">NID/Passport No: <span style="margin-left: 5px"></span></div>
                                <div class="info-text" style="border-bottom: 1px solid #126c38; padding: 3px">Date of Birth: <span style="margin-left: 5px"></span></div>
                                <div class="info-text" style="padding: 3px">Contact No: <span style="margin-left: 5px"></span></div>
                            </td>
                        </tr>
        ...
        <div class="item-section-wrap">
            ...
            <div class="item-wrap">
                <div class="item-photo-wrap">
                    ...
                    @if (!empty($raw->applicant_4_passport))
                        <div class="photo-item">
                            @php $hasAnyFile = false; @endphp

                            @if (!empty($raw->applicant_4_passport))
                                <div class="img-box" style="margin-bottom: 10px">
                                    <img style="width: 100px; height: 90" src="{{ asset('public/attachments/' . $raw->applicant_4_passport) }}" alt="Passport Image Fourth">
                                </div>
                                @php $hasAnyFile = true; @endphp
                            @endif

                            @unless ($hasAnyFile)
                                Please attach a Recent Passport Size Color Photograph of 4th Applicant/Authorized Signatory
                            @endunless
                        </div>
                    @else
                        <div class="photo-item">
                        ...
                        <tr>
                            ...
                            <td class="vcenter text-center">     
                                @if (!empty($raw->applicant_1_signature))
                                    <img style="width: 70px; height: 45px" src="{{ asset('public/attachments/' . $raw->applicant_1_signature) }}" alt="Signature Image">
                                    <span style="margin-left: 10px">{{$raw->create_time}}</span>
                                @else
                                    -
                                @endif     
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="vcenter text-center">     
                                @if (!empty($raw->applicant_2_signature))
                                    <img style="width: 70px; height: 45px" src="{{ asset('public/attachments/' . $raw->applicant_2_signature) }}" alt="Signature Image">
                                    <span style="margin-left: 10px">{{$raw->create_time}}</span>
                                @else
                                    -
                                @endif     
                        ...
                        <tr>
                            ...
                            <td class="vcenter text-center">     
                                @if (!empty($raw->applicant_3_signature))
                                    <img style="width: 70px; height: 45px" src="{{ asset('public/attachments/' . $raw->applicant_3_signature) }}" alt="Signature Image">
                                    <span style="margin-left: 10px">{{$raw->create_time}}</span>
                                @else
                                    -
                                @endif     
