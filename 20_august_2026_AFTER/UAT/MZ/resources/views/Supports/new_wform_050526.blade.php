...
<script src="{{ URL::asset('public/js/latest-v/flatpickr-4.6.13.min.js') }}"></script>
    ...
    {!! Form::open(['method'=>'post', 'action' => ['SupportsController@submitWform'] , 'enctype' => 'multipart/form-data']); !!}
    {!! Form::token(); !!}
    <style>
                    ...
                    <fieldset class="scheduler-border" style="background-color:#f5f5f5">
                        ...
                        <div class="table-responsive">
                            <table class="table table-condensed">
                                ...
                                <tr>
                                   {{-- <th colspan="4">
                                        <a href="#" data-id="" class="btn btn-warning" id="isInquiryApi" style="display: none;">Inquiry
                                            API</a>
                                    </th>--}}
                                </tr>
