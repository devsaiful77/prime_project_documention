...
})->name('login')->middleware(['module.access_service']);
...
Route::middleware(['module.access_service'])->group(function () {
    ...
    Route::post('Supports/printBpIdBtn/{stype}', ['middleware' => ['auth'], 'uses' => 'SupportsController@printBpIdBtn']);

    Route::post('Supports/printAuctionRequestBtn/{stype}', ['middleware' => ['auth'], 'uses' => 'SupportsController@printAuctionRequestBtn']);

    Route::post('Supports/ticketDetails/printBpId', ['middleware' => ['auth'], 'uses' => 'SupportsController@printBpIdTicketDetails'])->name('support.printBpIdTicketDetails');

     Route::post('Supports/ticketDetails/printAuction', ['middleware' => ['auth'], 'uses' => 'SupportsController@printAuctionTicketDetails'])->name('support.printAuctionTicketDetails');
    ...
    Route::get('/issue/group', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@index']);
    Route::get('/issue/group/add', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@add']);
    Route::post('/issue/group/store', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@store']);
    Route::get('/issue/group/edit/{id}', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@edit']);
    Route::get('/issue/group/view/{id}', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@view']);
    Route::post('/issue/group/update/{id}', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@update']);

    // ajax request
    Route::post('/workflow-wise/subgroup/user', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@workflowWiseSubgroup']);

    //Route::get('/issue-group/users-by-subgroup/{id}', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@getUsersBySubgroup']);
    // Route::post('/issue-group/users-by-subgroup', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@getUsersBySubgroup']);
    // Route::post('/get-issue-group', ['middleware' => ['auth'], 'uses' => 'IssueGroupController@getIssueGroup']);
    ...
    Route::post('Holidays/reject/{id}', ['middleware' => ['auth'], 'uses' => 'HolidaysController@holidayReject']);
