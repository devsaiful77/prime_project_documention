    ...
    */
    ...
    public function login(Request $request)
    {
		...
		if($request['reqMod'] == 'adSearch'){
                ...
                $userInfos = Adldap::search()->select(['mail', 'cn', 'sn', 'title','description', 'samaccountname','telephonenumber'])->where('samaccountname','=',$request['user_id'])->where('userAccountControl','=',512)->get();
		//dd($request['user_id'],$userInfos );
