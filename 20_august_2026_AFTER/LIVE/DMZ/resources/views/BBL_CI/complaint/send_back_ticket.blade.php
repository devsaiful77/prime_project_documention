...
<div class="bg-wrapper">
    ...
    <div class="d-block d-sm-none align-self-center">
        <form id="cifFormApp" action="{{ route('CI.complaint-update') }}" method="POST">
            @csrf
            <div class="container-fluid custom-layout app_view">
                ...
                <div class="dropdown-wrapper mb-4">
                    <label class="mb-1 d-block">Complaint Request</label>
                ...
                @if($uploadedAttachment->count() > 0)
                    @foreach($uploadedAttachment as $row)
                        <div class="align-items-center pt-3">
                            ...
                            @if($row->name)
                                <div class="mr-2 font-weight-bold" style="color: white; font-weight: bold;">{{ $row->name }}:</div>
                            @else
                                <div class="mr-2 font-weight-bold" style="color: white; font-weight: bold;">Bank attachment:</div>
                            @endif
                            <div class="">
            ...
            <div class="mt-3" style="text-align: right; margin-right: 1rem">
        ...
        <div class="row">
            <div class="web-item-wrap">
                <h4 class="service-title d-none d-sm-block">
                    @if($product_type == 2) Account Related Send Back Complaint Request @elseif($product_type == 3) Debit Card Related Complaint Send Back Request @elseif($product_type == 1) Credit Card Related Send Back Complaint Request @elseif($product_type == 4) Loan
                    Related Send Back Complaint Request @endif
                </h4>
                        ...
                        <div class="card mt-3 mb-5">
                            <div class="card-body input-wrapper">
                                ...
                                <div id="form_log_wrap">
                                    <form id="cifForm" action="{{ route('CI.complaint-update') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="ci_token" value="{{ $ci_token }}" />
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-center contenedor-fecha-interior-app otp_inputed_val">
                                    <input type="text" oninput="validateNumericInput(event)" inputmode="numeric" pattern="[0-9]*" tabindex="0" class="input-fecha otp_input" maxlength="1" required name="otp1" id="otp_1">
                                    <input type="text" oninput="validateNumericInput(event)" inputmode="numeric" pattern="[0-9]*" tabindex="0" class="input-fecha otp_input" maxlength="1" required name="otp2" id="otp_2">
                                    <input type="text" oninput="validateNumericInput(event)" inputmode="numeric" pattern="[0-9]*" tabindex="0" class="input-fecha otp_input" maxlength="1" required name="otp3" id="otp_3">
                                    <input type="text" oninput="validateNumericInput(event)" inputmode="numeric" pattern="[0-9]*" tabindex="0" class="input-fecha otp_input" maxlength="1" required name="otp4" id="otp_4">
                                    <input type="text" oninput="validateNumericInput(event)" inputmode="numeric" pattern="[0-9]*" tabindex="0" class="input-fecha otp_input" maxlength="1" required name="otp5" id="otp_5">
                                    <input type="text" oninput="validateNumericInput(event)" inputmode="numeric" pattern="[0-9]*" tabindex="0" class="input-fecha otp_input" maxlength="1" required name="otp6" id="otp_6">
                                </div>
                            </div>
                        </div>
