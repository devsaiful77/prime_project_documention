            ...
            @foreach($single['fields'] as $key => $r)
                @if($r->field_type==\App\Enum\FieldTypeEnum::TEXT)
                    <div class="input-wrapper mb-3 {{ $r->field_name }}">
                        ...
                        <input type="{{ $r->field_type }}" class="input-field text_eng" name="{{ $r->field_name }}" value="{{ old($r->field_name )}}"  placeholder="{{ $r->placeholder }}">
                    ...
                    @elseif($r->field_type==\App\Enum\FieldTypeEnum::PREV_DATE)
                        <div class="input-wrapper mb-3 {{ $r->field_name }}">
                            <label for="" class="input-label">{{ $r->label_name }}<span class="required">@if($r->is_required==1){{'*'}} @endif</span></label>
                            <input type="text" class="input-field datepickerPrev" name="{{ $r->field_name }}" placeholder="dd-mm-yyyy" maxlength="{{ $r->maximum_length }}" value="{{old($r->field_name)}}" readonly>
                            <div class="{{ $r->field_name }}_err error-message"></div>
                    ...
                    @elseif($r->field_type==\App\Enum\FieldTypeEnum::NEXT_DATE)
                        <div class="input-wrapper mb-3 {{ $r->field_name }}">
                            <label for="" class="input-label">{{ $r->label_name }}<span class="required">@if($r->is_required==1){{'*'}} @endif</span></label>
                            <input type="text" class="input-field datepickerNext" name="{{ $r->field_name }}" id="" placeholder="dd-mm-yyyy" maxlength="{{ $r->maximum_length }}" value="{{old($r->field_name)}}" readonly>
                            <div class="{{ $r->field_name }}_err error-message"></div>
                            <script nonce="{{ app('csp_nonce') }}">
                                $(function() {
                ...
                @elseif($r->field_type==\App\Enum\FieldTypeEnum::NUMBER)
                    <div class="input-wrapper mb-3 {{ $r->field_name }}">
                        <label for="" class="input-label">{{ $r->label_name }}<span class="required">@if($r->is_required==1){{'*'}} @endif</span></label>
                        <input type="{{ $r->field_type }}" class="input-field number_field" name="{{ $r->field_name }}" maxlength="{{ $r->maximum_length }}" value="{{old($r->field_name)}}" placeholder="{{ $r->placeholder }}">
                        <div class="{{ $r->field_name }}_err error-message"></div>
                    </div>
                @elseif($r->field_type==\App\Enum\FieldTypeEnum::DECIMAL)
                    <div class="input-wrapper mb-3">
                        <label for="" class="input-label">{{ $r->label_name }}<span class="required">@if($r->is_required==1){{'*'}} @endif</span></label>
                        <input type="text" class="input-field text_eng" name="{{ $r->field_name }}" maxlength="{{ $r->maximum_length }}" value="{{old($r->field_name)}}" placeholder="{{ $r->placeholder }}">
                        <div class="{{ $r->field_name }}_err error-message"></div>
                    </div>
                        ...
                        @foreach($single['fields'] as $key => $r)
                            @if($r->field_type==\App\Enum\FieldTypeEnum::TEXT)
                                ...
                                @elseif($r->field_type==\App\Enum\FieldTypeEnum::NEXT_DATE)
                                    <div class="input-wrapper mb-3 {{ $r->field_name }}">
                                        <label for="" class="input-label">{{ $r->label_name }}<span class="required">@if($r->is_required==1){{'*'}} @endif</span></label>
                                        <input type="text" class="input-field datepickerNext" name="{{ $r->field_name }}" placeholder="dd-mm-yyyy" maxlength="{{ $r->maximum_length }}" value="{{old($r->field_name)}}" readonly>
                                        <div class="{{ $r->field_name }}_err error-message"></div>
                                        <script nonce="{{ app('csp_nonce') }}">
                                            $(function() {
                                                $(".datepickerNext").datepicker({
