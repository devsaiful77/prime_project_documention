...
<head>
    ...
    <title>Prime Bank PLC # Customer Protal | {{ (!empty($title)) ? $title : "" }}</title>
            ...
            <div class="card border-0">
                <div class="card-body">
                    <div class="">
                      ...
                      {{-- <a href="{{ url('/') . '/access-CI?CIFNumber=PB1048863&myPrimeId=PB1048863&sessionId=' . $uniqueId}}" class="text-decoration-none text-center text-dark fs-5">
                        ...
                        <a href="{{ url('/') . '/access-CI?myPrimeId=PB1071242&sessionId=99855'}}" class="text-decoration-none text-center text-dark fs-5">
                            <img class="img-fluid mx-auto d-block"
                                 src="{{ url('/public/img/logo/Logo.png') }}"
                                 width="250px"
                                 alt="">
