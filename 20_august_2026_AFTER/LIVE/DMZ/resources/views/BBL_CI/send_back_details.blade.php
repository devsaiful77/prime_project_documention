    ...
    <div class="row">
        <div class="d-xsm-block d-sm-block d-md-none d-lg-none d-xl-none d d-xxl-none">
            <div class="s_b_t_bottom_hr">
                <p class="s_b_t_head pb-3 mb-0">Service Send Back Tickets</p>
            </div>
        ...
        <div class="d-xsm-none d-sm-none d-md-block d-lg-block d-xl-block d-xxl-block web_a_verify">
            <h4 class="s_b_t_head pb-4 mb-0">Service Send Back Tickets</h4>
                    ...
                    @forelse( $sendBackTickets as $row )
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{route('CI.send-back.ticket',['issueId'=>$row->serviceName->id, 'refNum'=>$row->reference_number, 'viewMode'=>'web', 'CIToken' => $ci_token, 'request_type' => 'service'])}}" class="text-decoration-underline">
                                ...
                                <a href="#" data-toggle="tooltip" data-bs-placement="right" title="{{$sendBack}}" style="font-size: 20px" class="">
                                        <i class="far fa-comment-alt" style="color: #2157b5;"></i>
                                    </a>
