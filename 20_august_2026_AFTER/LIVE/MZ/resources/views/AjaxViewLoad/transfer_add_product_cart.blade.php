<tr id="uniqMaterialId<?php echo $appendCount;?>">
  {!! Form::hidden('transfer_children['.$appendCount.'][product_id]',$productData['id'] ); !!}
  ...
  <td class="text-center vcenter">{{$productData['name']}} ({{(!empty($productData['product_attribute']['name'])) ? $productData['product_attribute']['name'] : '-'}})</td>
	<td class="text-center vcenter">
      {!!
          Form::text('transfer_children['.$appendCount.'][batch_no]',(!empty($batch_no)) ? $batch_no : ""  ,[
            'class' => 'form-control',
            'label'=>false,
            'readonly'=>true,
            'autocomplete'=>'off',
  ...
  <td class="text-center vcenter">
      {!!
          Form::text('transfer_children['.$appendCount.'][price]',(!empty($productData['sale_price'])) ? $productData['sale_price'] : ""  ,[
            'class' => 'form-control text-right transferCommonClass',
	...
	<td class="text-center vcenter">
      {!!
          Form::text('transfer_children['.$appendCount.'][quantity]',(!empty($dataForView["quantity"])) ? $dataForView["quantity"] : 0,[
            'class' => 'form-control transferCommonClass',
  ...
  <td class="text-center vcenter">
      {!!
          Form::text('transfer_children['.$appendCount.'][vat]',(!empty($dataForView["vat"])) ? $dataForView["vat"] : 0  ,[
            'class' => 'form-control transferCommonClass',
  ...
  <td class="text-center vcenter">
      ...
      ?>
      {!!
          Form::text('transfer_children['.$appendCount.'][amount]',(!empty($dataForView["amount"])) ? $dataForView["amount"] : $netAmountWithVat  ,[
  ...
  <td><button type="button" class="btn btn-danger removeAddMoreProduct"><i class="fa fa-minus"></i></button></td> 
</tr>   
