...
@IF ($id != null)
  {!!
      Form::open([
        'method'=>'post',
        'action' => ['DivisionsController@update',$id] ,
...
@ELSE
  {!!
      Form::open([
        'method'=>'post',
        'action' => ['DivisionsController@store'] ,
        'id'=>'formId',
        'class'=>'form-horizontal form-label-left',
        'enctype' => 'multipart/form-data'
      ]);
...
@ENDIF
  ...
  <div class="form-group">
      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        ...
        !!}
        <button type="button" class="btn btn-info gradient" onclick="cancel('/Divisions{{ $additionalParams}}')">Back</button>
      </div>
  </div>
