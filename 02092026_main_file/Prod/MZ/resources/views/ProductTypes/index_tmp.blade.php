    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Product Type Actions</h5>
                    ...
                    <td class="vcenter actions text-center">
                        ...
                        @if($isChecker == false)
                            @if($data['form_status'] == 7)
                                <a href="{{ url('ProductTypes/tmp-edit', $data['id']) }}" class="btn btn-success gradient ajax_page" title="Edit" escape="false"> <i class="fa fa-pencil"></i> Edit</a>
                            @endif
                                <a href="{{ url('delete/tmp-data', ['id' => $data['id'], 'table' => 'product_types_tmp']) }}" class="btn btn-danger gradient ajax_page" title="Delete" escape="false">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#sendBack-btn').click(function(e){
                ...
                const id = $('#assign_button').data('id');
                let url = "{{ url('ProductTypes/send-back', '') }}";
                url += '/' + id;
            ...
            $('#reject-btn').click(function(e){
                ...
                const id = $('#assign_button').data('id');
                let url = "{{ url('ProductTypes/reject', '') }}";
                url += '/' + id;
            ...
            $('#approve-btn').click(function(){
                const id = $('#assign_button').data('id');
                let url = "{{ url('ProductTypes/approve', '') }}";
                url += '/' + id;
